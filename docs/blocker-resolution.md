...
### Перенос Telegram в группу — подготовлен
...
11 целевых тестов прошли. Реальное переключение и тест в группе ещё не подтверждены;
до успешной привязки сохраняется прежний получатель. Инструкция: [telegram-notifications.md](telegram-notifications.md).
...
при необходимости. Фактический статус индексации и поисковый трафик ещё не подтверждены.
