...
class TravelOffer(Base):
    ...
    __table_args__ = (
        UniqueConstraint("data_provider_id", "external_id", name="uq_offer_provider_external"),
    ...
    observation_key: Mapped[str | None] = mapped_column(String(64))
    departure_precision: Mapped[str] = mapped_column(String(8), default="TIME", nullable=False)
